...
for i in range(args.num_seeds):
    ...
    if test_pgmorl:
        cmd = (
            ...
            "--ob-rms "
            "--raw "
            "--save-dir {}/pgmorl/{}/".format(seed, save_dir, i)
        )
        commands.append(cmd)
    ...
    if test_ra:
        cmd = (
            ...
            "--ob-rms "
            "--raw "
            "--save-dir {}/ra/{}/".format(seed, save_dir, i)
        )
        commands.append(cmd)
    ...
    if test_random:
        cmd = (
            ...
            "--ob-rms "
            "--raw "
            "--save-dir {}/random/{}/".format(seed, save_dir, i)
        )
        commands.append(cmd)
    ...
    if test_pfa:
        cmd = (
            ...
            "--ob-rms "
            "--raw "
            "--save-dir {}/pfa/{}/".format(seed, save_dir, i)
        )
        commands.append(cmd)
    ...
    if test_moead:
        cmd = (
            ...
            "--ob-rms "
            "--raw "
            "--save-dir {}/moead/{}/".format(seed, save_dir, i)
        )
        commands.append(cmd)
