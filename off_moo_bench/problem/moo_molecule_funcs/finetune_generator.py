...
from .hgraph2graph.hgraph import MoleculeDataset
from .hgraph2graph.hgraph import HierVAE, common_atom_vocab, PairVocab
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epoch):
        ...
        dataset = MoleculeDataset(good_smiles, args.vocab, args.atom_vocab, args.batch_size)
