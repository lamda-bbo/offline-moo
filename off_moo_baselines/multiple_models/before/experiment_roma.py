...
def SyntheticFunction(train_mode: str = "RoMA",
                      tasks: List[str] = [],
    ...
    from off_moo_baselines.multiple import multiple_run 
...
def RESuite(train_mode: str = "RoMA",
                tasks: List[str] = [],
                cpus = psutil.cpu_count(logical=True),
                gpus = torch.cuda.device_count(),
                num_parallel = 1,
...
def MONASSequence(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
...
def MONASLogits(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
...
def MOCOPermutation(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
...
def MOCOContinuous(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
...
def ScientificDesignContinuous(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
...
def ScientificDesignSequence(train_mode: str = "RoMA",
            tasks: List[str] = [],
            cpus = psutil.cpu_count(logical=True),
            gpus = torch.cuda.device_count(),
            num_parallel = 1,
